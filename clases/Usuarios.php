<?php 
    ...
    return $datos;
        ...
        public function eliminarUsuario($idUsuario) {
            ...
            // Eliminar primero de t_usuarios
            $sqlUsuario = "DELETE FROM t_usuarios WHERE id_usuario = ?";
            $queryUsuario = $conexion->prepare($sqlUsuario);
            $queryUsuario->bind_param('i', $idUsuario);
            $exitoUsuario = $queryUsuario->execute();
            $queryUsuario->close();
        
            // Obtener el id_persona antes de eliminar de t_persona
            $idPersona = $this->obtenerIdPersona($idUsuario);
        
            // Eliminar de t_persona
            $sqlPersona = "DELETE FROM t_persona WHERE id_persona = ?";
            $queryPersona = $conexion->prepare($sqlPersona);
            $queryPersona->bind_param('i', $idPersona);
            $exitoPersona = $queryPersona->execute();
            $queryPersona->close();
        
            return $exitoUsuario && $exitoPersona;
        }
        public function actualizarPassword($idUsuario, $password) {
            ...
            // Vincular parámetros
            $query->bind_param("si", $password, $idUsuario);
